...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('accounts_account', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('up_to_date', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('user_quota', self.gf('django.db.models.fields.IntegerField')(default=10)),
            ('storage_quota', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['accounts.StorageQuota'], unique=True)),
        ))
        db.send_create_signal('accounts', ['Account'])

        # Adding model 'AccountMessage'
        db.create_table('accounts_accountmessage', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('message', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('account', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['accounts.Account'])),
        ))
        db.send_create_signal('accounts', ['AccountMessage'])

        # Adding model 'StorageQuota'
        db.create_table('accounts_storagequota', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('amount', self.gf('django.db.models.fields.IntegerField')(default=500)),
            ('units', self.gf('django.db.models.fields.CharField')(max_length=2)),
        ))
        db.send_create_signal('accounts', ['StorageQuota'])
    ...
    def backwards(self, orm):
        ...
        # Deleting model 'AccountMessage'
        db.delete_table('accounts_accountmessage')

        # Deleting model 'StorageQuota'
        db.delete_table('accounts_storagequota')
