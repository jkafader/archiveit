...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'AccountMessage.target_url'
        db.add_column('accounts_accountmessage', 'target_url',
                      self.gf('django.db.models.fields.URLField')(null=True, blank=True, max_length=200),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'AccountMessage.target_url'
        db.delete_column('accounts_accountmessage', 'target_url')
    ...
    models = {
        ...
        'accounts.accountmessage': {
            ...
            'target_url': ('django.db.models.fields.URLField', [], {'null': 'True', 'blank': 'True', 'max_length': '200'}),
