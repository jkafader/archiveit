...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'SeedCapturePattern'
        db.create_table('archiveit_seedcapturepattern', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('pattern', self.gf('django.db.models.fields.CharField')(max_length=200)),
        ))
        db.send_create_signal('archiveit', ['SeedCapturePattern'])

        # Adding field 'Seed.capture'
        db.add_column('archiveit_seed', 'capture',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['archiveit.SeedCapturePattern'], blank=True, null=True),
                      keep_default=False)

        # Adding field 'Collection.last_crawl'
        db.add_column('archiveit_collection', 'last_crawl',
                      self.gf('django.db.models.fields.DateTimeField')(blank=True, null=True),
                      keep_default=False)


        # Changing field 'Collection.owner'
        db.alter_column('archiveit_collection', 'owner_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['accounts.Account'], null=True))

        # Changing field 'Collection.created_on'
        db.alter_column('archiveit_collection', 'created_on', self.gf('django.db.models.fields.DateTimeField')(null=True))

    def backwards(self, orm):
        # Deleting model 'SeedCapturePattern'
        db.delete_table('archiveit_seedcapturepattern')

        # Deleting field 'Seed.capture'
        db.delete_column('archiveit_seed', 'capture_id')

        # Deleting field 'Collection.last_crawl'
        db.delete_column('archiveit_collection', 'last_crawl')


        # Changing field 'Collection.owner'
        db.alter_column('archiveit_collection', 'owner_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True))

        # Changing field 'Collection.created_on'
        db.alter_column('archiveit_collection', 'created_on', self.gf('django.db.models.fields.DateTimeField')())
    ...
    models = {
        ...
        'archiveit.crawl': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'metadata': ('picklefield.fields.PickledObjectField', [], {'blank': 'True', 'null': 'True'}),
