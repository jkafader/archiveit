...
class Migration(SchemaMigration):
    ...
    models = {
        ...
        'archiveit.seed': {
            ...
            'groups': ('django.db.models.fields.related.ManyToManyField', [], {'blank': 'True', 'to': "orm['archiveit.SeedGroup']", 'symmetrical': 'False', 'null': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'metadata': ('jsonfield.fields.JSONField', [], {'blank': 'True', 'null': 'True'}),
            'public': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'url': ('django.db.models.fields.URLField', [], {'max_length': '200'})
        ...
        'archiveit.seedfolder': {
            ...
            'parent': ('django.db.models.fields.related.ForeignKey', [], {'null': 'True', 'to': "orm['archiveit.SeedFolder']", 'blank': 'True', 'related_name': "'children'"})
        },
        'archiveit.seedgroup': {
        ...
        'archiveit.seedscoperule': {
            ...
            'document_limit': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'rule_match': ('django.db.models.fields.CharField', [], {'max_length': '200'}),
            'rule_type': ('django.db.models.fields.CharField', [], {'max_length': '20'}),
            'seeds': ('django.db.models.fields.related.ManyToManyField', [], {'blank': 'True', 'to': "orm['archiveit.Seed']", 'symmetrical': 'False', 'null': 'True'}),
